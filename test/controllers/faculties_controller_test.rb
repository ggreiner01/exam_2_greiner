...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { administration_id: @faculty.administration_id, committee_id: @faculty.committee_id, fname: @faculty.fname, lname: @faculty.lname, phone_number: @faculty.phone_number, position: @faculty.position } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { administration_id: @faculty.administration_id, committee_id: @faculty.committee_id, fname: @faculty.fname, lname: @faculty.lname, phone_number: @faculty.phone_number, position: @faculty.position } }
