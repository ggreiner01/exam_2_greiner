...
class CommitteesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create committee" do
    assert_difference('Committee.count') do
      post committees_url, params: { committee: { administration_id: @committee.administration_id, name: @committee.name, num_of_faculty: @committee.num_of_faculty } }
    end
  ...
  test "should update committee" do
    patch committee_url(@committee), params: { committee: { administration_id: @committee.administration_id, name: @committee.name, num_of_faculty: @committee.num_of_faculty } }
