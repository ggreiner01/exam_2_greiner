...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { faculty_id: @assessment.faculty_id, grade: @assessment.grade, program_id: @assessment.program_id } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { faculty_id: @assessment.faculty_id, grade: @assessment.grade, program_id: @assessment.program_id } }
